...
# All-in-one script for DeepSeek-OCR benchmarking
# This script:
...
MODEL_SHORT_NAME="ds"  # Short name for output files (e.g., ds, dpsk, internvl)
...
log_section "DeepSeek-OCR Benchmarking Pipeline"
...
micromamba run -n "$CONDA_ENV" python scripts/ocr/ds_ocr_inference.py \
    --input "$DATA_DIR" \
    --output "$PRED_DIR" \
