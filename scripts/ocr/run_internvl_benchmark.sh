...
# All-in-one script for InternVL3.5-8B benchmarking
# This script:
...
MODEL_SHORT_NAME="internvl"  # Short name for output files (e.g., ds, dpsk, internvl)
...
log_section "InternVL3.5-8B Benchmarking Pipeline"
...
micromamba run -n "$CONDA_ENV" python scripts/ocr/internvl_3.5_241.py \
    --input "$DATA_DIR" \
    --output "$PRED_DIR" \
